...
Item {
    ...
    ScrollView {
        ...
        ColumnLayout {
            width: scrollView.width - 40  // Учитываем отступы
            anchors.margins: 20
            spacing: 10
            ...
            Label {
                text: "Total Sessions: " + timeController.fullSessionCount
                font.pixelSize: 20
                Layout.alignment: Qt.AlignHCenter
            }
            ...
            Label {
                text: {
                    ...
                    if (streak > 0) {
                        return "Max Consecutive Gaming Days: " + streak + " (From " + end + " to " + start + ")"
                    } else {
                        return "Max Consecutive Gaming Days: 0 (No consecutive days found)"
                    }
                }
                font.pixelSize: 20
                Layout.alignment: Qt.AlignHCenter
            ...
            RowLayout {
                ...
                Canvas {
                    ...
                    property var playtime: timeController.playtimeByTimeOfDay
                    ...
                    onPaint: {
                        ...
                        var barWidth = width / 5; // 4 интервала + промежутки
                        var margin = barWidth;
                        ...
                        for (var j = 0; j < 4; j++) {
                            ...
                            var xPos = margin + j * barWidth;
                            ctx.fillStyle = "#2196F3"; // Синий цвет для отличия
                            ctx.fillRect(xPos, height - 20 - barHeight, barWidth - 5, barHeight);
                        }
                    }
                }
                ...
                ColumnLayout {
                    ...
                    Repeater {
                        ...
                        Label {
                            text: modelData + ": " + timeController.playtimeByTimeOfDay[index].toFixed(1) + " hours"
                            font.pixelSize: 18
                            Layout.alignment: Qt.AlignLeft
                        }
                    }
            ...
            Item {
                Layout.preferredHeight: 20  // Добавляем небольшой отступ внизу
            }
        }
    }
}